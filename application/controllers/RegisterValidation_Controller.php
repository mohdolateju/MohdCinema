...
class RegisterValidation_Controller extends CI_Controller {
    ...
    function index()
    {
        ...
        $this->form_validation->set_error_delimiters('<span style="color: white; background-color: red;
                                                                   padding:1% ">', '</span>');
        ...
        else
        {
            ...
            $data['username']=$this->create_new_costumer();
    ...
    function create_new_costumer(){
        ...
        $this->RegisterValidation_Model->set_new_customer($nextid,$firstname,$lastname,$email,$password);
